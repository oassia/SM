...

{
	...
	if ($service_name=="AddCompany")
		{
			   ...
			   $smarty->display("smarty/templates/addcompany.tpl");
	...
	else if ($service_name=="AddSector")
		{
			   ...
			   $smarty->display("smarty/templates/addsector.tpl");
	...
	else if ($service_name=="AllotShares")
	{
			...
			$smarty->display("smarty/templates/allotshares.tpl");
	...
	{
			$smarty->display("smarty/templates/initializegame.tpl");
	...
	{
			$smarty->display("smarty/templates/shortsellingflag.tpl");
	}
	...
	{
			$smarty->display("smarty/templates/bettingcheck.tpl");
	}
...
$smarty->display("smarty/templates/changeshareprice.tpl");



	}
	else if ($service_name=="InitializeCompanies")
		$smarty->display("smarty/templates/initializeCompanies.tpl");
	...
	$smarty->display("smarty/templates/administrator.tpl");
	}
