...

{
			...
			$smarty->assign("rate_of_interest",$rate_of_interest);
				   ...
				   $smarty->display("smarty/templates/loan.tpl");
			}
	...
	//		
		...
		//				
			...
			$smarty->display('smarty/templates/share_normal.tpl');
			}
			...
			$smarty->display('smarty/templates/share_short_selling.tpl');
	...
	//		
		...
		//				
			...
			$smarty->display('smarty/templates/batting.tpl');
			}
			...
			
			{
				...
				$smarty->display("smarty/templates/mutualfund.tpl");
			}
...
else if (   verify()  )
{
		checkSession();
		include 'banner.php';
		$query=sprintf("Select * from customer_balance where customer_id='%s'",$_SESSION['customer_id']);
			$result=mysql_query($query);
			$balance_result=mysql_fetch_assoc($result);
			$balance=$balance_result["current_balance"];
		...
		$smarty->assign('current_balance',$balance);
		$smarty->display("smarty/templates/client.tpl");
}
